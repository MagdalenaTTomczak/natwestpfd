...
public interface EnhancedTestInterface {
	 ...
	 */
		void onTestFinished(boolean result, String className, String methodName);
	 ...
	 */
		void onTestStarted(String className, String methodName) throws MalformedURLException;
	 ...
	 */
		void onTestFailure(String className, String methodName, String message, String stack);
	 ...
	 */
		void onTestPassed(String className, String methodName);
	 ...
	 *            The method name of the test
	 */
		void onTestIgnored(String className, String methodName);
}
