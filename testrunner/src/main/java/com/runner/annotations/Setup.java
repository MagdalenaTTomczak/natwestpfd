...
public @interface Setup {
	...
	/**
	 * A enumeration used to identify the style of com.runner.report to output at the end
	 * of a test cycle. By default this is a PDF com.runner.report.
	 * 
	 * @author ryandixon1993@gmail.com
	 *
	 */
	...
	/**
	 * An array of {@link ReportType} used to generate a com.runner.report at the end of the test cycle.
	 * 
	 * @return - The format of com.runner.report to output
	 */
	 ...
	 * collation of all features the AUT supports. This is added to the com.runner.report
	 ...
	 * collation of all known defects on the AUT. This is added to the com.runner.report to
	 ...
	 * com.runner.report to help with conforming to AGILE practices.
	 * 
	...
	/**
	 * Set a boolean flag to allow suites with the {@link Ignore} annotation to
	 * be included as part of the com.runner.report. For example, include manual suites for
	 * you to fill in post-automation.
	 * 
	 * @return A boolean representing whether the com.runner.report should reflect suites
