 ...
 * the test suite to the com.runner.runner. All test classes should be annotated with this
 * in order to identify where to look for {@link TestInformation} com.runner.annotations.
 * 
...
public @interface SuiteInformation {
	 ...
	 * Epics and Stories in which these suites are created under. Note: This is
